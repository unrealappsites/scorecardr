      ...
      <div className="w-full max-w-sm px-6 pt-6 pb-16">
        ...
        <div className="flex items-center gap-2 mb-8">
          {editingGameName ? (
            <>
              ...
              />
              <button onClick={() => setEditingGameName(false)} aria-label="Save game name">
            ...
            <>
              ...
              <button onClick={() => setEditingGameName(true)} aria-label="Rename game">
        ...
        >
          ...
          <input
            ...
            style={{ color: INK }}
          />
          <button onClick={addPlayer} className="text-xs font-semibold uppercase tracking-wide" style={{ color: AMBER_DARK }}>
            Add
          </button>
        </div>
